...
#             # Extract predictions and find the top one
...
#             # Display prediction like YOLO output
...
#             top1_confidence = results[0].probs.top1conf.item()  # Confidence as a float
...
#             # Convert results' image with predictions to numpy and display
#             results_image = results[0].plot()  # This creates an image with predictions overlaid
#             st.image(results_image, caption="YOLO Model Prediction with Bounding Boxes", use_column_width=True)
